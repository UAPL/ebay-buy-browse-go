...
type SearchByImageApiService service

type ApiSearchByImageRequest struct {
	ctx                  _context.Context
	ApiService           *SearchByImageApiService
	aspectFilter         *string
	categoryIds          *string
	charityIds           *string
	fieldgroups          *string
...
func (r *ApiSearchByImageRequest) Execute() (SearchPagedCollection, *_nethttp.Response, error) {
...
*/
func (a *SearchByImageApiService) SearchByImage(ctx _context.Context) *ApiSearchByImageRequest {
	return &ApiSearchByImageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SearchByImageApiService) SearchByImageExecute(r *ApiSearchByImageRequest) (SearchPagedCollection, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SearchByImageApiService.SearchByImage")
	if err != nil {

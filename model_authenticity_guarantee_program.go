...
// checks if the AuthenticityGuaranteeProgram type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticityGuaranteeProgram{}
...
func NewAuthenticityGuaranteeProgram() *AuthenticityGuaranteeProgram {
	this := AuthenticityGuaranteeProgram{}
	return &this
}
...
func (o AuthenticityGuaranteeProgram) MarshalJSON() ([]byte, error) {
...
func (o AuthenticityGuaranteeProgram) ToMap() (map[string]interface{}, error) {
...
type NullableAuthenticityGuaranteeProgram struct {
	value *AuthenticityGuaranteeProgram
	isSet bool
}

func (v NullableAuthenticityGuaranteeProgram) Get() *AuthenticityGuaranteeProgram {
	return v.value
}

func (v *NullableAuthenticityGuaranteeProgram) Set(val *AuthenticityGuaranteeProgram) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthenticityGuaranteeProgram) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthenticityGuaranteeProgram) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthenticityGuaranteeProgram(val *AuthenticityGuaranteeProgram) *NullableAuthenticityGuaranteeProgram {
	return &NullableAuthenticityGuaranteeProgram{value: val, isSet: true}
}

func (v NullableAuthenticityGuaranteeProgram) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthenticityGuaranteeProgram) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
**DiscountPercentage** | Pointer to **string** | This field expresses the percentage of the seller discount based on the value in the &lt;code&gt;originalPrice&lt;/code&gt; container. | [optional] 

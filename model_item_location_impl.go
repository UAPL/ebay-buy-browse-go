...
// checks if the ItemLocationImpl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemLocationImpl{}
...
func (o ItemLocationImpl) MarshalJSON() ([]byte, error) {
...
func (o ItemLocationImpl) ToMap() (map[string]interface{}, error) {
...
type NullableItemLocationImpl struct {
	value *ItemLocationImpl
	isSet bool
}

func (v NullableItemLocationImpl) Get() *ItemLocationImpl {
	return v.value
}

func (v *NullableItemLocationImpl) Set(val *ItemLocationImpl) {
	v.value = val
	v.isSet = true
}

func (v NullableItemLocationImpl) IsSet() bool {
	return v.isSet
}

func (v *NullableItemLocationImpl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemLocationImpl(val *ItemLocationImpl) *NullableItemLocationImpl {
	return &NullableItemLocationImpl{value: val, isSet: true}
}

func (v NullableItemLocationImpl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemLocationImpl) UnmarshalJSON(src []byte) error {
	v.isSet = true
